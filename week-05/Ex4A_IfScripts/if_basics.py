...
# a)If x divided by y is 5, print “x divided by y is 5” and set the value of x to 1 – otherwise print "are the valuables set up correctly?"
if x / y == 5:
...
# e) Add a final print statement to say “The final value of x is __ and the final value of y is__"(displaying the actual values in place of the blanks)
